...
public class AddCompletionCriterionHandler : BaseCommandHandler, IRequestHandler<AddCompletionCriterionCommand, Unit>
{
    private readonly ITicketRepository _ticketRepository;

    public AddCompletionCriterionHandler(
    ...
    public async Task<Unit> Handle(AddCompletionCriterionCommand request, CancellationToken cancellationToken)
    {
