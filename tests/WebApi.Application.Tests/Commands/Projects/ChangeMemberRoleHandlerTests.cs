...
public class ChangeMemberRoleHandlerTests : BaseCommandHandlerTest
{
    private ChangeMemberRoleHandler _handler;
    ...
    public async Task 正常系_Handle()
    {
        ...
        // Act
        var command = new ChangeMemberRoleCommand(project.Id, user.Id, ProjectRole.RoleType.Member);
    ...
    public async Task 異常系_Projectが存在しない場合()
    {
        // Arrange
        var user = _userBuilder.Build();
        var command = new ChangeMemberRoleCommand(Guid.NewGuid(), user.Id, ProjectRole.RoleType.Member);
    ...
    public async Task 異常系_Userが存在しない場合()
    {
        ...
        var command = new ChangeMemberRoleCommand(project.Id, Guid.NewGuid(), ProjectRole.RoleType.Member);
