...
public class ReopenCompletionCriterionHandlerTests : BaseCommandHandlerTest
{
    private readonly ReopenCompletionCriterionHandler _handler;
    private readonly Mock<ITicketRepository> _ticketRepository;
    private readonly TicketBuilder _ticketBuilder;

    public ReopenCompletionCriterionHandlerTests()
    {
        _ticketRepository = new Mock<ITicketRepository>();
        _ticketBuilder = new TicketBuilder();

        _handler = new ReopenCompletionCriterionHandler(
