...
public class CompleteCompletionCriterionHandlerTests : BaseCommandHandlerTest
{
    private readonly CompleteCompletionCriterionHandler _handler;
    private readonly Mock<ITicketRepository> _ticketRepository;
    private readonly TicketBuilder _ticketBuilder;

    public CompleteCompletionCriterionHandlerTests()
    {
        _ticketRepository = new Mock<ITicketRepository>();
        _ticketBuilder = new TicketBuilder();

        _handler = new CompleteCompletionCriterionHandler(
