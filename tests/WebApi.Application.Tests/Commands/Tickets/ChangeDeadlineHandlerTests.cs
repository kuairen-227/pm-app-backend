...
using MediatR;
using Moq;
using WebApi.Application.Commands.Tickets.ChangeDeadline;
...
public class ChangeDeadlineHandlerTests : BaseCommandHandlerTest
{
    private readonly ChangeDeadlineHandler _handler;
